...
class WallDataset(TrajDataset):
    def __init__(
        ...
        self.actions = torch.load(self.data_path / "actions.pth") / action_scale
    ...
    def get_all_actions(self):
        ...
        for i in range(len(self.states)):
            result.append(self.actions[i, : self.get_seq_length(i), :])
    ...
    def get_frames(self, idx, frames):
        ...
        info = {
            "fix_door_location": self.door_locations[idx, frames][0],
            "fix_wall_location": self.wall_locations[idx, frames][0],
        }
