...
def create_objective_fn(alpha, alpha_vis, base, mode="last"):
    """
    Loss calculated on the last pred frame.
    Args:
        alpha: int - proprioceptive loss weight
        alpha_vis: int - visual loss weight
    ...
    def objective_fn_last(z_obs_pred, z_obs_tgt):
        ...
        loss = alpha_vis * loss_visual + alpha * loss_proprio
        return loss
